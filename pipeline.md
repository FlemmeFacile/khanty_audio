...
II	Pseudo-Phoneme Dictionary	
    ...
    3. K-Means Training	Cluster 
        W2V2 features to create dictionary of K=200 centroids (pseudo-phonemes). 
    4. Pseudo-Phoneme Labelling	
        Assign nearest centroid ID to each frame of Finnish audio. Create VITS metadata file: audio.wav|pseudo_phoneme_ids|speaker.
III	VITS Training	
    5. VITS Pre-training	
